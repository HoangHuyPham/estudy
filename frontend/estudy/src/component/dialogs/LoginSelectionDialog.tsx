...
import { LoginBasicDialog } from "@/component/dialogs/LoginBasicDialog";
...
export const LoginSelectionDialog: React.FC = () => {
  ...
  const handleLoginGoogle = (token: CredentialResponse | null) => {
    axiosClient.post<APIResponse<string>>(Endpoints.AUTH.LOGIN_WITH_GOOGLE, { token: token?.credential } as LoginWithGoogleRequest).then(res => {
